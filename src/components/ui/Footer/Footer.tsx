        ...
        <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300">
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 grid grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-16 py-20">
                <div className="space-y-6 col-span-2">
                    <Link href="#">
                        <span className="text-transparent bg-clip-text bg-gradient-to-tr from-blue-800 to-indigo-400 font-bold text-2xl">PictoIA</span>
                    </Link>
                    <p className="max-w-lg">
                        PictoIA es una innovadora plataforma dedicada a transformar y mejorar tus fotos mediante el uso de tecnología avanzada de inteligencia artificial. Nos enfocamos en ofrecer resultados de alta calidad de manera rápida y sencilla.
                    </p>
                </div>

                {footerBlocks.map((footerBlock) => (
                    <FooterBlockItem key={footerBlock.title} {...footerBlock} />
                ))}

                <div className="space-y-6 col-span-2">
                    <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Suscríbete a nuestro boletín</h1>
                    <form className="w-full max-w-2xl flex flex-col sm:flex-row gap-3">
                        <input type="email" placeholder="tucorreo@gmail.com" className="px-5 py-2.5 rounded-md outline-none flex-1 bg-gray-200 dark:bg-gray-800" />
            ...
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
                <div className="w-full flex flex-col md:flex-row gap-4 items-center sm:justify-between py-3 border-t border-gray-200 dark:border-t-gray-800 text-gray-700 dark:text-gray-300">
                    <div className="flex text-center sm:text-left sm:min-w-max">
                        <p> © 2024 PictoIA. Todos los derechos reservados </p>
                    </div>
                    <div className="flex justify-center sm:justify-end w-full gap-3">
                        <a href="#" aria-label="enlace social" rel="noreferer">
